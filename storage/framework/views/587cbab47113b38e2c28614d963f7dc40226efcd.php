...
<div class="container">
        ...
        <div>
            ...
            <?php echo Form::open(array('route'=>'enseignent.store')); ?>
               ...
               <div class="form-group">
                ...
                <?php echo Form::select('id_emploit', $data['emp'],null, ['placeholder' => 'choisit un emploit...']); ?>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Emp_web\resources\views/emploit/creer/enseignant.blade.php ENDPATH**/ ?>